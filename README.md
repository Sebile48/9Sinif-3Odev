...
Yukarıdaki örneği kullanarak **kendi ölçümlerinizle** bir tablo oluşturun (hiç değilse birkaç frame benim ölçümlerinden farklı olsun.) Kullandığınız Google Sheet için [https://docs.google.com/spreadsheets/d/19ZywysIYLh4-I9diyDRVU5kgqIJcV9i2iJ3L5qDXdF0/edit?usp=drivesdk ](https://docs.google.com/spreadsheets/d/19ZywysIYLh4-I9diyDRVU5kgqIJcV9i2iJ3L5qDXdF0/edit?usp=drivesdk) link verin (Google Sheet herkese açık erişimli olsun.) 

a) Denkleminizi **-5,54E-03+1,74x+-1,15x^2**. Sizce a, b, ve c'nin fiziksel anlamları ne olabilir? Sizce niçin a'nın değeri negatif? 
